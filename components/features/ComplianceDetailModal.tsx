...
export default function ComplianceDetailModal({
  ...
  const [item, setItem] = useState<ComplianceRecord | null>(null);
  ...
  return (
    <>
      <Modal open={open} onClose={onClose} title="Compliance Record" size="md">
        {loading ? (
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 pt-4 border-t border-slate-100 text-sm">
              ...
              <Row label="Reviewed By" value={item.reviewedBy ?? "—"} mono />
